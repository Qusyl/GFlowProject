...
{
    private readonly Dictionary<int, NodeExecution> _nodes;

    private readonly Dictionary<int, List<Edge>> _incomingEdges;

    private readonly Dictionary<int, List<Edge>> _outComingEdges;

    public IReadOnlyDictionary<int, NodeExecution> Nodes => _nodes.AsReadOnly();
    ...
    public ExecutionGraph(Dictionary<int, NodeExecution> nodes,Dictionary<int, List<Edge>> incomingEdges, Dictionary<int, List<Edge>> outComingEdges)
    {
        _nodes = nodes;
        _incomingEdges = incomingEdges;
        _outComingEdges = outComingEdges;
    }
    public NodeExecution? GetNode(int id)
    {
